...
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |  F1  |  F2  |  F3  |  F4  |  øF5  |                    |  F6  |  F7  |  F8  |  F9  | F10  | F11  |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
...
[_RAISE] = LAYOUT( \
  ...
  _______, XXXXXXX, LSFT(KC_COPY), LSFT(KC_PASTE),  KC_HOME,  KC_END,                            XXXXXXX, NO_OSTR, NO_ARNG, XXXXXXX, XXXXXXX, XXXXXXX, \
  LALT(KC_ESC), LALT(NO_1), LALT(NO_2),  LALT(NO_3),  LALT(NO_4),  LALT(NO_5),            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX, XXXXXXX, \
  _______, KC_UNDO, KC_CUT,  KC_COPY,  KC_PASTE, XXXXXXX,  _______,         _______, XXXXXXX, NO_AE, XXXXXXX, XXXXXXX, XXXXXXX, _______, \
                       _______, _______, _______, _______, _______,         _______, _______, _______, _______, _______ \
),

[_NUMPAD] = LAYOUT( \
  _______, _______, _______, _______ , _______, _______,                            _______, _______, _______, _______, _______ ,_______, \
  _______, XXXXXXX, XXXXXXX, XXXXXXX,  KC_PGUP, XXXXXXX,                            XXXXXXX, NO_7, NO_8, NO_9, XXXXXXX, XXXXXXX, \
  _______, XXXXXXX, XXXXXXX,  KC_HOME, KC_END, XXXXXXX,                            NO_0,    NO_4, NO_5, NO_6, XXXXXXX, XXXXXXX, \
  _______, XXXXXXX, XXXXXXX,  XXXXXXX, KC_PGDN, XXXXXXX,  _______,         _______, NO_0,    NO_1, NO_2, NO_3, XXXXXXX, _______, \
                       _______, _______, _______, _______, _______,         KC_BSPC, NO_0, NO_DOT, _______, NO_COMM \
),

[_SHIFT] = LAYOUT( \
  KC_MPLY,  NO_1,   NO_2,    NO_3,    NO_4,    NO_5,                                         NO_6,    NO_7,    NO_8,    NO_9,    NO_0,  KC_MNXT, \
  KC_ESC,   NO_Q,   NO_W,    NO_E,    NO_R,    NO_T,                                         NO_Y,    NO_U,    NO_I,    NO_O,    NO_P,  _______, \
  LT(_NUMPAD, KC_TAB),   NO_A,   NO_S,    NO_D,    NO_F,    NO_G,                          NO_H,    NO_J,    NO_K,    NO_L, NO_COLN,  NO_DQUO, \
  _______,  NO_Z,   NO_X,    NO_C,    NO_V,    NO_B, KC_MUTE,                       XXXXXXX, NO_N,    NO_M, S(NO_LABK),  NO_RABK, NO_QUES,  _______, \
                 _______, _______, _______,   _______, _______,        _______, KC_RAISE, _______, _______, _______ \
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
